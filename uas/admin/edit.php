...
{   
    ...
    // update user data
    $result = mysqli_query($koneksi, "UPDATE barang SET nama_barang='$nama_barang',harga_barang='$harga_barang',stok_barang='$stok_barang' WHERE id_barang=$id");
...
<body style="font-family:arial">
 <center><h2>TOKO EMBAH</h2></center>
 <hr />
